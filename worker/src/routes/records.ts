...
recordsRouter.post("/", async (c) => {
  // Per-user quota was removed (Phase 2): guests and registered users
  // can save as many records as they want. Spam/abuse protection
  // belongs at a different layer (rate limiter / abuse heuristics).
  ...
  await db.insert(records).values({
    ...
    numbersJson: parsed.data.numbers
